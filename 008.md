...
binary context, for example in encryption. This specification defines binary
encodings for common objects such as message IDs and feed IDs to be used in
binary feed formats and encryption formats.
