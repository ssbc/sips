...
Parsing it .... expect to need to filter leading `#` and to need to treat
different capitalisations the same (e.g. `NewZealand` vs `newzealand`).

**TODO**: more detail (see `ssb-ref` ?)
